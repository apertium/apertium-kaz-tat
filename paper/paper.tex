...
%	\ex
%	\begin{xlist}
%		\ex Мен үйге баруым керек
%		\gll мен үй-GA бар-у-Iм керек \\
%		I home-\gmk{Dat} go-\gmk{Ger}-\gmk{1sg} need \\
%		\glt \eng{I need to go home}
%
%		\ex Мин өйгә барырга кирәк
%		\gll мин өй-GA бар-IргA кирәк \\
%		I home-\gmk{Dat} go-\gmk{Inf} need \\
%		\glt \eng{I need to go home}
%	\end{xlist}
%\end{exe}
...
\a
\begingl
\gla Мен үйге баруым керек. //
\glb мен үй-GA бар-у-Iм керек //
\glb I home-\gmk{Dat} go-\gmk{Ger}-\gmk{1sg} need //
\glft \eng{I need to go home.} //
\endgl
\a
\begingl
\gla Мин өйгә барырга кирәк. //
\glb мин өй-GA бар-IргA кирәк //
\glb I home-\gmk{Dat} go-\gmk{Inf} need //
\glft \eng{I need to go home.} //
\endgl
\xe
