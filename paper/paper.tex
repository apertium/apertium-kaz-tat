...
%\begin{subtables}
	...
	\caption{The 2\super{nd} person pronoun systems of Kazakh and Tatar}
	\label{tab:2pprons}
\end{table}
%\end{subtables}
...
Tatar has separate words for \eng{[physical] life} (гомер) and \eng{life [as a human condition]} (тормыш), whereas Kazakh only has one word (өмір).  The lexical selection rule provided in Figure~\ref{fig:lrx3} chooses the latter Tatar translation after the adjective рухани \eng{spiritual}.
