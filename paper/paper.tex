...
As can be seen in Table~\ref{table:coverage}, the coverage for the news corpora approaches
that of a broad-coverage MT system, with one word in ten unknown. These unknown words are 
principally proper nouns. For the Wikipedia corpus, the coverage is substantially worse. This is 
due to \textbf{FIXME: why?}
