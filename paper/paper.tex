...
An MT system between Tatar and Kazakh is potentially of great use to the language communities.  Direct MT can save time and money over going through e.g.\ Russian (and the system is much easier to develop).  Some accompanying language resources (e.g.,\ morphol.\ analysers, disambiguators) can be repurposed.
...
The output of each morphological analyser is highly ambiguous, measured at around 2.4 morphological analyses per form for Kazakh.  The goal of the CG rules is to select the correct analysis when there are multiple analyses.  Currently, ambiguity is down to 1.4 analyses per form.
...
%FIXME NOW
All evaluation was tested against version 0.1.0, or {\tt {\small rNNNNNN}} in the Apertium SVN.\footnote{\url{https://apertium.svn.sourceforge.net/svnroot/apertium/trunk/apertium-kaz-tat}}
...
from SVN.\footnote{\url{https://apertium.svn.sourceforge.net/svnroot/apertium/trunk/apertium-kaz-tat}} 
